...
var Table_Table = /*#__PURE__*/function () {
  ...
  Table_createClass(Table, [{
     ...
     *
     * @param {WrappedRange} rng
     * @param {Boolean} isShifts
     */
    value: function tab(rng, isShifts) {
      var cell = dom.ancestor(rng.commonAncestor(), dom.isCell);
      var table = dom.ancestor(cell, dom.isTable);
      var cells = dom.listDescendant(table, dom.isCell);
      var nextCell = lists[isShifts ? 'prev' : 'next'](cells, cell);
...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function representShortcut(editorMethod) {
      ...
      if (env.isMac) {
        shortcut = shortcut.replace('CMD', '⌘').replace('Shifts', '⇧');
      }
        ...
        children: [this.button({
          ...
          click: function click(event) {
            ...
            if (eventName === 'openPalette') {
              ...
              var $palette = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()($parent.find('#' + $picker.data('event')).find('.note-color-row')[0]); // Shifts palette chips
  ...
  options: {
    ...
    keyMap: {
      pc: {
        ...
        'CTRL+I': 'italic',
        'CTRL+U': 'underline',
        'CTRL+Shifts+S': 'strikethrough',
        'CTRL+BACKSLASH': 'removeFormat',
        'CTRL+Shifts+L': 'justifyLeft',
        'CTRL+Shifts+E': 'justifyCenter',
        'CTRL+Shifts+R': 'justifyRight',
        'CTRL+Shifts+J': 'justifyFull',
        'CTRL+Shifts+NUM7': 'insertUnorderedList',
        'CTRL+Shifts+NUM8': 'insertOrderedList',
      ...
      mac: {
        ...
        'CMD+I': 'italic',
        'CMD+U': 'underline',
        'CMD+Shifts+S': 'strikethrough',
        'CMD+BACKSLASH': 'removeFormat',
        'CMD+Shifts+L': 'justifyLeft',
        'CMD+Shifts+E': 'justifyCenter',
        'CMD+Shifts+R': 'justifyRight',
        'CMD+Shifts+J': 'justifyFull',
        'CMD+Shifts+NUM7': 'insertUnorderedList',
        'CMD+Shifts+NUM8': 'insertOrderedList',
