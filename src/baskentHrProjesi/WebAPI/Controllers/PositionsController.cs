...
public class PositionsController : BaseController
{
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<DeletedPositionResponse>> Delete([FromRoute] int id)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetByIdPositionResponse>> GetById([FromRoute] int id)
    {
    ...
    [HttpGet]
    public async Task<ActionResult<GetListResponse<GetListPositionListItemDto>>> GetList([FromQuery] PageRequest pageRequest)
    {
