...
using Application.Services.LeaveTypes;
using Application.Services.Positions;
using Application.Services.TimeEntries;
using Application.Services.Timesheets;
using Application.Services.Shifts;
...
public static class ApplicationServiceRegistration
{
    ...
    )
    {
        ...
        services.AddScoped<ITimeEntryService, TimeEntryManager>();
        services.AddScoped<ITimesheetService, TimesheetManager>();
        services.AddScoped<ITimesheetService, TimesheetManager>();
