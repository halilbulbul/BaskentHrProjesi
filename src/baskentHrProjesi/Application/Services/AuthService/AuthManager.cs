...
public class AuthManager : IAuthService
{
    ...
    public async Task<AccessToken> CreateAccessToken(User user, Employee? employee = null)
    {
    ...
    {
        NArchitecture.Core.Security.Entities.RefreshToken<Guid, Guid> newCoreRefreshToken =
    ...
    public async Task RevokeDescendantRefreshTokens(RefreshToken refreshToken, string ipAddress, string reason)
    {
        RefreshToken? childToken =
            await _refreshTokenRepository.GetAsync(r => r.Token == refreshToken.ReplacedByToken);
    ...
    {
        NArchitecture.Core.Security.Entities.RefreshToken<Guid, Guid> coreRefreshToken =
            _tokenHelper.CreateRefreshToken(user, ipAddress);
